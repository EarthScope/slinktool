...
static char sl_typecode (char type);
...
ds_streamproc (DataStream **streamroot, char *pathformat, const SLMSrecord *msr,
               int reclen, char type, int idletimeout)
{
  ...
  foundstream = ds_getstream (streamroot, msr, definition,
                              filename, idletimeout);
